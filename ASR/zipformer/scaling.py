...
from torch.amp import custom_bwd, custom_fwd # FIX: FutureWarning from library-version
...
class MulForDropout3(torch.autograd.Function):
    ...
    @staticmethod
    @custom_fwd(device_type='cuda')  # FIX: FutureWarning from library-version add (device_type='cuda')
    ...
    @staticmethod
    @custom_bwd(device_type='cuda')  # FIX: FutureWarning from library-version add (device_type='cuda')
